...
class ActivityModel {
  ...
  factory ActivityModel.fromJson(Map<String, dynamic> json) => ActivityModel(
    ...
    route: (json['route'] as List).map((p) => LatLng(p['lat'], p['lng'])).toList(),
    distanceMeters: (json['distanceMeters'] as num).toDouble(),
    durationSeconds: json['durationSeconds'],
    steps: json['steps'],
    elevations: (json['elevations'] as List?)?.map((e) => (e as num).toDouble()).toList() ?? [],
  ...
  ActivityModel copyWith({List<String>? photoPaths}) => ActivityModel(
    ...
    durationSeconds: durationSeconds, steps: steps,
    elevations: elevations, type: type,
